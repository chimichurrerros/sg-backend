...
-- Save this file as docs/seed_permissions.sql
...
-- 2. Delete existing permissions for ADMIN to prevent duplicates
DELETE FROM "Permissions"
WHERE "RoleId" = (SELECT "Id" FROM "Roles" WHERE UPPER("Name") = 'ADMIN');

-- 3. Insert all permissions for ADMIN role in bulk
INSERT INTO "Permissions" ("Id", "Name", "RoleId")
SELECT gen_random_uuid(), p.name, r."Id"
FROM (
    SELECT name FROM (
        VALUES
