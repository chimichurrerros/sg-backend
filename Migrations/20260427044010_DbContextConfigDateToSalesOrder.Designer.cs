...
namespace BackEnd.Migrations
{
    ...
    [Migration("20260427044010_DbContextConfigDateToSalesOrder")]
    partial class DbContextConfigDateToSalesOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "check_status", new[] { "pending", "cashed", "voided" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "check_type", new[] { "day", "deferred" });
            ...
            modelBuilder.Entity("BackEnd.Models.MovementType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
