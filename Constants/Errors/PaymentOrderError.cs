...
public static class PaymentOrderError
{
    ...
    public const string PurchaseOrderMustNotBeCancelled = "La order de compra no debe estar cancelada";    public const string PaymentAlreadyProcessed = "La orden de pago ya fue procesada";
